...
// Setup canvas
let cnv = document.getElementById("srPlayCanvas");
...
// Global Variables
let target1X = Math.random() * 740 + 30; // Target draws anywhere within the canvas except always 30 away from the walls of the canvas
